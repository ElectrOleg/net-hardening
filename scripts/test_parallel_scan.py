...
from app.models import DataSource, Policy, Result, Rule, Scan
...
def run_test():
    ...
    with app.app_context():
        ...
        # Configure Celery eagerly and in-memory
        ...
        mock_lock = MagicMock()
        try:
            with patch("app.utils.distributed_lock.get_lock", return_value=mock_lock):
