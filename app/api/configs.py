...
def get_latest_config(device_id):
    ...
    snap = (
        ConfigSnapshot.query.filter_by(device_id=device_id)
...
def get_config_snapshot(snap_id):
    ...
    """
    snap = db.get_or_404(ConfigSnapshot, snap_id)
...
def diff_config_snapshots(snap_id, other_snap_id):
    ...
    """
    snap_a = db.get_or_404(ConfigSnapshot, snap_id)
    snap_b = db.get_or_404(ConfigSnapshot, other_snap_id)
