...
class NetconfProvider(ConfigSourceProvider):
    ...
    def fetch_config(self, device_id: str, context: dict = None) -> FetchResult:
        ...
        try:
            ...
            if self.filter_xml:
                # Use subtree filter
                config = mgr.get_config(source=self.datastore, filter=("subtree", self.filter_xml))
            else:
                # Get full config
            ...
            return FetchResult(success=True, config=config_xml, format="xml")
    ...
    def get_operational_data(self, filter_xml: str) -> FetchResult:
        ...
        try:
            ...
            return FetchResult(success=True, config=data_xml, format="xml")
    ...
    def rpc(self, rpc_xml: str) -> FetchResult:
        ...
        try:
            ...
            return FetchResult(success=True, config=result_xml, format="xml")
